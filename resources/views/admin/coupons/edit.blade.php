        ...
        <form class="form-new-product form-style-1" method="POST"
          ...
          <fieldset class="name">
            ...
            <input class="flex-grow" type="text" placeholder="Coupon Value" name="discount_value" tabindex="0"
              value="{{ old('discount_value', (int) $coupon->discount_value) }}" aria-required="true" required="">
          ...
          <fieldset class="name">
            ...
            <input class="flex-grow" type="text" placeholder="Cart Value" name="minimum_purchase" tabindex="0"
              value="{{ old('minimum_purchase', (int) $coupon->minimum_purchase) }}" aria-required="true" required="">
          ...
          <fieldset class="name">
            ...
            <input class="flex-grow" type="date" placeholder="Expiry Date" name="expired_at" tabindex="0"
              value="{{ old('expired_at', $coupon->expired_at ? $coupon->expired_at->format('Y-m-d') : '') }}"
